...
import auth  # contains personal authentication data
...
class Discount:
    ...
    def send_email(self):
        ...
        email = auth.email()  # ask for the email
        password = auth.password()  # password for login
        ...
        if float(real_price) < 45.00:  # compare the scraped price to the original price
